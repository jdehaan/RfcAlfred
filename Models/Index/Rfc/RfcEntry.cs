...
namespace Alfred.Models.Index.Rfc
{
    ...
    public class RfcEntry
    {
        ...
        public RfcStatus CurrentStatus { get; set; }

        [XmlElement("publication-status")]
        public RfcStatus PublicationStatus { get; set; }
        ...
        public string WorkingGroupAcronym { get; set; }
